...
### ✨ Features
- RAG improvements (chunking) and code cleanup (9d1db94)

### 🐛 Fixes
- resolve mypy type errors and linting issues (db491b9)
- resolve CI failures, type errors, and version mismatch (v0.3.5) (7d4537e)

### 📝 Other Changes
- docs: update roadmap and todo list following v0.3.5 audit (18543e0)
- chore: add mypy to uaft lint task (754a661)
- docs: update README version to v0.3.5 (df6eb22)
- docs: update changelog and readme for v0.3.4 (151e1f2)
- chore: bump to v0.3.4 with security patches and optimizations (068a9a9)
- chore: bump vscode extension version to 0.3.3 and update build artifacts (9eaf1b6)
- docs: update version to v0.3.2 in README (ef8e9ab)
